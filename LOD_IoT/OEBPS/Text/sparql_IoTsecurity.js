...
function makeBaseUrl(key) {
    return "http://133.5.24.71/IoTSecurity/" + key;
}
...
function collect_image(key) {
    ...
    sparql = "select * from <http://133.5.24.71/IoTSecurity/> where {?s rdfs:label \"" + imagevar + "\";foaf:img ?img.}"
...
function collect_video(key) {
    ...
    sparql = "select * from <http://133.5.24.71/IoTSecurity/> where {?s rdfs:label \"" + videovar + "\";rdfs:seeAlso ?seeAlso.}"
...
function collect_text(key) {
    ...
    sparql = "select * from <http://133.5.24.71/IoTSecurity/> where {?s rdfs:label \"" + textvar + "\";rdfs:comment ?comment.}"
